...
HOST="mysql-db.cxwdtgsgm2fs.us-east-1.rds.amazonaws.com" # RDS MySQL Endpoint
USER="admin"
PASSWORD="mysqldbfacts"
DATABASE="Facts"

# mysql -h mysql-db.cxwdtgsgm2fs.us-east-1.rds.amazonaws.com -P 3306 -u admin -p 
...
<body>
    ...
    <script>
        ...
        button.addEventListener('click', () => {
            fetch('http://WebProjectALB-1001706930.us-east-1.elb.amazonaws.com/data.json') // Application Load Balancer DNS 
...
nginx_conf=$(cat <<EOF
    server {
        ...
        location / {
            ...
            add_header 'Access-Control-Allow-Origin' 'http://webproject.acyc.link';
